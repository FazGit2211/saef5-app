        ...
        <>
            <Card>
                <CardContent>
                    ...
                    {alert || !loadingEvent ? <Alert variant="filled" severity="warning">{dataEvent.message}</Alert> : null}
                    {alert || !loadingEvent ? <Alert variant="filled" severity="success">Agregado Correctamente</Alert> : null}
                </CardContent>
            </Card>
        </>
    )
